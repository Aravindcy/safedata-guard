# safedata-guard - feature guide

The detailed reference for safedata-guard. For the pitch, the two execution modes, and a quick start, see the [README](../README.md).
